...
void DeviceWindow::camStatus()
{
    ...
    if ( ping_for_cam1 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam2 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam3 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam4 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam5 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam6 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam7 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam8 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam9 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam10 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam11 == 0) //Pinging NVR to check if it active
    {
    ...
    if ( ping_for_cam12 == 0) //Pinging NVR to check if it active
    {
