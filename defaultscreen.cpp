...
void defaultScreen::opendriverlogindialog(){
...
void defaultScreen::on_pushButton_driverLogin_1_clicked()
{
    //For the first
    buttonpress_d++;
    if (buttonpress_d == 1){
...
void defaultScreen::on_pushButton_driverLogin_2_clicked()
{
    //For the first
    buttonpress_d++;
    if (buttonpress_d == 1){
...
void defaultScreen::on_pushButton_driverLogin_3_clicked()
{
    //For the first
    buttonpress_d++;
    if (buttonpress_d == 1){
...
void defaultScreen::on_pushButton_driverLogin_4_clicked()
{
    //For the first
    buttonpress_d++;
    if (buttonpress_d == 1){
...
void defaultScreen::closeScreen(){
...
void defaultScreen::playStream(){

//    _dfSm = libvlc_media_new_location(_vlcinstance, listAllCamsDefScreen[0]);
//    libvlc_media_player_set_media (_dfSmp, _dfSm);

//    _dfSm2 = libvlc_media_new_location(_vlcinstance, listAllCamsDefScreen[1]);
//    libvlc_media_player_set_media (_dfSmp2, _dfSm2);

//    _dfSm3 = libvlc_media_new_location(_vlcinstance, listAllCamsDefScreen[2]);
//    libvlc_media_player_set_media (_dfSmp3, _dfSm3);

//    _dfSm4 = libvlc_media_new_location(_vlcinstance, listAllCamsDefScreen[3]);
